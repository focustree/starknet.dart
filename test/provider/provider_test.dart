...
void main() {
  group('WriteProvider', () {
    test('invokeTransactionV0', () async {
    ...
    test('mintAspectNFT', () async {
      ...
      final request = InvokeTransactionRequest(
        ...
        calldata: [
          ...
          Felt.fromHexString('0x4543514a50355058566372344d727357454a48694345'),
    ...
    test('declareTransaction', () async {
      ...
      final request = DeclareTransactionRequest(
        declareTransaction: DeclareTransaction(max_fee: defaultMaxFee),
      );
