    ...
    test('invokeTransaction', () async {
      ...
      final request = InvokeTransactionRequest(
          functionInvocation: FunctionCall(
              ...
              entryPointSelector: StarknetFieldElement.fromHex(
