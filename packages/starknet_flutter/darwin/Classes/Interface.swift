...
private class StarknetInterfaceCodecReader: FlutterStandardReader {
...
private class StarknetInterfaceCodecWriter: FlutterStandardWriter {
...
private class StarknetInterfaceCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return StarknetInterfaceCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return StarknetInterfaceCodecWriter(data: data)
  }
}

class StarknetInterfaceCodec: FlutterStandardMessageCodec {
  static let shared = StarknetInterfaceCodec(readerWriter: StarknetInterfaceCodecReaderWriter())
}
...
class StarknetInterfaceSetup {
  ...
  static var codec: FlutterStandardMessageCodec { StarknetInterfaceCodec.shared }
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: StarknetInterface?) {
    let storeSecretChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.StarknetInterface.storeSecret", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeSecretChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.StarknetInterface.removeSecret", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getSecretChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.StarknetInterface.getSecret", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let biometryAvailableChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.StarknetInterface.biometryAvailable", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
