...
@Suppress("UNCHECKED_CAST")
private object BiometricsStorePluginCodec : StandardMessageCodec() {
...
interface BiometricsStorePlugin {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy {
      BiometricsStorePluginCodec
    }
    /** Sets up an instance of `BiometricsStorePlugin` to handle messages through the `binaryMessenger`. */
    @Suppress("UNCHECKED_CAST")
    fun setUp(binaryMessenger: BinaryMessenger, api: BiometricsStorePlugin?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.BiometricsStorePlugin.storeSecret", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.BiometricsStorePlugin.removeSecret", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val keyArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.BiometricsStorePlugin.getSecret", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val keyArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.BiometricsStorePlugin.isBiometryAvailable", codec)
        if (api != null) {
