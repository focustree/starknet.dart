...
@Suppress("UNCHECKED_CAST")
private object SecureStorePluginCodec : StandardMessageCodec() {
...
interface SecureStorePlugin {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy {
      SecureStorePluginCodec
    }
    /** Sets up an instance of `SecureStorePlugin` to handle messages through the `binaryMessenger`. */
    @Suppress("UNCHECKED_CAST")
    fun setUp(binaryMessenger: BinaryMessenger, api: SecureStorePlugin?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.SecureStorePlugin.storeSecret", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.SecureStorePlugin.removeSecret", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val keyArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.SecureStorePlugin.getSecret", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val keyArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.SecureStorePlugin.isBiometryAvailable", codec)
        if (api != null) {
