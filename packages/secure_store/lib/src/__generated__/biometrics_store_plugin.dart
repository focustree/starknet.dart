...
class _BiometricsStorePluginCodec extends StandardMessageCodec {
  const _BiometricsStorePluginCodec();
  @override
...
class BiometricsStorePlugin {
  /// Constructor for [BiometricsStorePlugin].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  BiometricsStorePlugin({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _BiometricsStorePluginCodec();

  Future<void> storeSecret(String arg_key, Uint8List arg_privateKey, BiometricOptions? arg_biometricOptions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.BiometricsStorePlugin.storeSecret', codec,
  ...
  Future<void> removeSecret(String arg_key) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.BiometricsStorePlugin.removeSecret', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
  ...
  Future<Uint8List?> getSecret(String arg_key, BiometricOptions? arg_biometricOptions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.BiometricsStorePlugin.getSecret', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
  ...
  Future<bool> isBiometryAvailable() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.BiometricsStorePlugin.isBiometryAvailable', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
