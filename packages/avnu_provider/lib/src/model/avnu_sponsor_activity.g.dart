...
_$AvnuSponsorActivityGetSponsorActivityImpl
    _$$AvnuSponsorActivityGetSponsorActivityImplFromJson(
...
Map<String, dynamic> _$$AvnuSponsorActivityGetSponsorActivityImplToJson(
        _$AvnuSponsorActivityGetSponsorActivityImpl instance) =>
    <String, dynamic>{
      'name': instance.name,
