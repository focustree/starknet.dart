...
abstract class TraceProvider {
  ...
  ///
  /// [Spec](https://github.com/starkware-libs/starknet-specs/blob/master/api/starknet_trace_api_openrpc.json#L11-L39)
  Future<GetTransactionTrace> traceTransaction(Felt transactionHash);

  /// Simulates transactions.
  ///
  /// [Spec](https://github.com/starkware-libs/starknet-specs/blob/master/api/starknet_trace_api_openrpc.json#L41-L106)
  Future<SimulateTransactions> simulateTransactions(
      SimulateTransactionsRequest request);

  /// Traces all transactions in a block.
  ///
  /// [Spec](https://github.com/starkware-libs/starknet-specs/blob/master/api/starknet_trace_api_openrpc.json#L107-L145)
