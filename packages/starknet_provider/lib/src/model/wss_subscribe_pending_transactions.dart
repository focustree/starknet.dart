...
@freezed
class WssSubscribePendingTransactionsResponse with _$WssSubscribePendingTransactionsResponse {
  ...
  factory WssSubscribePendingTransactionsResponse.fromJson(Map<String, Object?> json) =>
