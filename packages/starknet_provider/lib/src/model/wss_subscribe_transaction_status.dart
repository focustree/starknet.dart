...
@freezed
class WssSubscribeTransactionStatusResponse with _$WssSubscribeTransactionStatusResponse {
  ...
  factory WssSubscribeTransactionStatusResponse.fromJson(Map<String, Object?> json) =>
