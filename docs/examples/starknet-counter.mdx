...
```
- Install starknet-devnet 0.0.7
```sh
asdf install starknet-devnet 0.0.7
asdf global starknet-devnet 0.0.7
```
...
5. Create `devnet-acct.json` with the following content:
...
```
6. Export the private key to the environment variable.
```sh
...
...
Transaction 0x03bab0133a5a71cdff5c322a77c4372765df1c80874e579bea09e88db714f812 confirmed
Class hash declared:
0x06fbdea8714409dd889de2be7b76a801b0061df1f80548d977d5a91952229e52
```

8. Deploy the contract.
```sh
~/contract$ starkli deploy --watch --rpc http://localhost:5050 --account devnet-acct.json 0x06fbdea8714409dd889de2be7b76a801b0061df1f80548d977d5a91952229e52
```
