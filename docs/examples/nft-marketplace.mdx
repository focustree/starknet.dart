...
2. Clone the ark project and run it locally ([follow README instructions](https://github.com/ArkProjectNFTs/ark-project?tab=readme-ov-file#quick-start-for-local-development)):
